...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 12 13:18:58 2018
...
class TextCNN(object):
    ...
    def __init__(self, 
        ...
        l2_loss = tf.Variable(tf.constant(0.0) ,name="l2_loss")
        ...
        with tf.name_scope("embedding"), tf.device('/cpu:0') : 
            ...
            # the reason we expand it is because we need to use the conv2d, and it need a dimension called channel.
