...
tf.flags.DEFINE_string("positive_data_file", "./data/valid/validtodo.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/valid/invalidtodo.txt", "Data source for the negative data.")
...
def save_to_pb(sess):
    ...
    model_file = "./saved_model_todo.pb"
